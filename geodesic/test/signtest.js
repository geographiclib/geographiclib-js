...
describe("GeographicLib", function() {
  describe("SignTest", function () {
    ...
    it("check AngRound", function () {
      ...
      assert.strictEqual(m.AngRound(-eps/64), -0.0   );
      assert.strictEqual(m.AngRound(-    0 ), -0.0   );
      assert.strictEqual(m.AngRound(     0 ), +0.0   );
      assert.strictEqual(m.AngRound( eps/64), +0.0   );
      assert.strictEqual(m.AngRound( eps/32), +eps/32);
    ...
    it("check sincosd", function () {
      ...
      assert.sincosCheck(m.sincosd(-810), -1.0, +0.0);
      assert.sincosCheck(m.sincosd(-720), -0.0, +1.0);
      assert.sincosCheck(m.sincosd(-630), +1.0, +0.0);
      assert.sincosCheck(m.sincosd(-540), -0.0, -1.0);
      assert.sincosCheck(m.sincosd(-450), -1.0, +0.0);
      assert.sincosCheck(m.sincosd(-360), -0.0, +1.0);
      assert.sincosCheck(m.sincosd(-270), +1.0, +0.0);
      assert.sincosCheck(m.sincosd(-180), -0.0, -1.0);
      assert.sincosCheck(m.sincosd(- 90), -1.0, +0.0);
      assert.sincosCheck(m.sincosd(-  0), -0.0, +1.0);
      assert.sincosCheck(m.sincosd(+  0), +0.0, +1.0);
      assert.sincosCheck(m.sincosd(+ 90), +1.0, +0.0);
      assert.sincosCheck(m.sincosd(+180), +0.0, -1.0);
      assert.sincosCheck(m.sincosd(+270), -1.0, +0.0);
    ...
    it("check atan2d", function () {
      ...
      assert.strictEqual( m.atan2d(-  0 , -  0 ), -180 );
      assert.strictEqual( m.atan2d(+  0 , +  0 ), +0.0 );
      assert.strictEqual( m.atan2d(-  0 , +  0 ), -0.0 );
      assert.strictEqual( m.atan2d(+  0 , -  1 ), +180 );
      assert.strictEqual( m.atan2d(-  0 , -  1 ), -180 );
      assert.strictEqual( m.atan2d(+  0 , +  1 ), +0.0 );
      assert.strictEqual( m.atan2d(-  0 , +  1 ), -0.0 );
      ...
      assert.strictEqual( m.atan2d(-  1 ,  -inf), -180 );
      assert.strictEqual( m.atan2d(+  1 ,  +inf), +0.0 );
      assert.strictEqual( m.atan2d(-  1 ,  +inf), -0.0 );
    ...
    it("check sum", function () {
      ...
      assert.strictEqual( m.sum(+9, -9).s, +0.0 );
      assert.strictEqual( m.sum(-9, +9).s, +0.0 );
      assert.strictEqual( m.sum(-0, +0).s, +0.0 );
      assert.strictEqual( m.sum(+0, -0).s, +0.0 );
      assert.strictEqual( m.sum(-0, -0).s, -0.0 );
      assert.strictEqual( m.sum(+0, +0).s, +0.0 );
    ...
    it("check AngNormalize", function () {
      ...
      assert.strictEqual( m.AngNormalize(-720), -0.0 );
      assert.strictEqual( m.AngNormalize(-540), -180 );
      assert.strictEqual( m.AngNormalize(-360), -0.0 );
      assert.strictEqual( m.AngNormalize(-180), -180 );
      assert.strictEqual( m.AngNormalize(  -0), -0.0 );
      assert.strictEqual( m.AngNormalize(  +0), +0.0 );
      assert.strictEqual( m.AngNormalize( 180), +180 );
      assert.strictEqual( m.AngNormalize( 360), +0.0 );
      assert.strictEqual( m.AngNormalize( 540), +180 );
